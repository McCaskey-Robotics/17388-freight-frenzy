...
@TeleOp
public class MechanumDrive_21_22_2player
extends LinearOpMode {
    ...
    public void additionalControl() {
        if(gamepad1.left_trigger > .1){
            ...
            spinner.setPower(-gamepad1.right_trigger * .50);
        }else{
            spinner.setPower(0);
        }
    ...
    public void armControl() {
        ...
        if (this.gamepad2.y && !this.yState && !this.aState) {
            this.yState = true;
        }
        if (this.gamepad2.a && !this.yState && !this.aState) {
            this.aState = true;
        }
        ...
        if ((double)this.gamepad2.right_trigger > 0.75) {
            boolean bl = this.rtState = !this.rtState;
            while ((double)this.gamepad2.right_trigger > 0.25) {
            }
        }
        if (this.gamepad2.left_bumper) {
