...
@TeleOp
public class MechanumDrive21_22_Copy4
extends LinearOpMode {
    ...
    public void additionalControl() {
        if (this.gamepad1.left_bumper) {
            this.spinner.setPower(0.3);
        } else if (this.gamepad1.right_bumper) {
            this.spinner.setPower(-0.3);
        } else {
            this.spinner.setPower(0.0);
        }
        if (this.gamepad1.a || (double)this.gamepad1.left_stick_y < -0.1) {
            // empty if block
        }
    }
    ...
    public void armControl() {
        ...
        this.telemetry.addData("TeamElement Distance", (Object)this.elementDetector.getDistance(DistanceUnit.INCH));
        this.clearLeft = true;
        ...
        if (this.gamepad1.left_trigger > 0.0f) {
        ...
        if ((double)this.gamepad1.left_trigger > 0.1) {
            this.intake.setPower((double)(-this.gamepad1.left_trigger));
            this.rtState = false;
        } else if (this.colorGreen > 200.0) {
            this.intake.setPower(0.0);
            this.yState = true;
    ...
    private double tableEncoderToDeg(double ticks) {
        return (ticks - this.startingTablePos) / 760.0 * 360.0;
    }
